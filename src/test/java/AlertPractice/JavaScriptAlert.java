...
public class JavaScriptAlert {
    ...
    public void javascriptAlertTest1() throws InterruptedException {
        ...
        // we need to switch the driver to the alert class
        Alert alert=driver.switchTo().alert();
        // We have 4 method in Alert class to handle the js alerts.
        // 1- accept-OK 2- dismiss-Cancel 3- sendKey 4- getText
    ...
    public void test4(){
        ...
        softAssert.assertEquals(actualText,expectedText,"JSPrompt Text is validated");

        String alertMessage="Muammer Turan";
