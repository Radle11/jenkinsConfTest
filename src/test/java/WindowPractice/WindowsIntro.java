...
public class WindowsIntro {
    ...
    public void test2(){
        ...
        for(String id:ids){
            ...
            if(!id.equals(currentPageId)){// it will switch the driver to new window if id is not equals to parent id
                driver.switchTo().window(id);
    ...
    public void test3(){
        ...
        // Close all the window if they are not equals to your first page
